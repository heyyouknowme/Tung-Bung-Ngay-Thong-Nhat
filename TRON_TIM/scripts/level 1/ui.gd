extends CanvasLayer  # hoặc Node/Control tùy
...
var time_left := 20  # 20 giây
var on_level_win : Callable = func(): pass  # callback mặc định, gán từ bên ngoài
...
func _ready():
	...
	Global.current_level_num = 1  # tùy level
...
func _on_level_complete():  # Gọi khi người chơi thắng
	level_timer.stop()
	if on_level_win:
