...
/** @type {string} */
const CACHE_VERSION = '1746560337|58618626';
/** @type {string} */
const CACHE_PREFIX = 'tung_bung_ngay_t-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'tung_bung_ngay_thong_nhat.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["tung_bung_ngay_thong_nhat.html","tung_bung_ngay_thong_nhat.js","tung_bung_ngay_thong_nhat.offline.html","tung_bung_ngay_thong_nhat.icon.png","tung_bung_ngay_thong_nhat.apple-touch-icon.png","tung_bung_ngay_thong_nhat.audio.worklet.js","tung_bung_ngay_thong_nhat.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tung_bung_ngay_thong_nhat.wasm","tung_bung_ngay_thong_nhat.pck"];
